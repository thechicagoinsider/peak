...
foreach ($blocks as $block) {
    ...
    $block_classes[$block] = $config->get("block.{$block}.block_divider");
...
/*
 * Add vertical nav classes
 */

$vertical_nav_classes = $config->get('sidebar_fixed') ? ' tm-sidebar-fixed' : '';
$vertical_nav_classes .= $config->get('sidebar_togglebar') == 0 ? ' tm-sidebar-togglebar' : ' tm-sidebar-open';
$config->set('$vertical_nav_classes', trim($vertical_nav_classes));
